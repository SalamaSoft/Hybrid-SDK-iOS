...
//  CodeInHand
//
//  Created by XingGu Liu on 12-9-21.
...
{
    return [WebServiceUtil doBasicMethod:url isDownload:NO isPostMethod:isPost paramNames:paramNames paramValues:paramValues requestTimeoutInterval:_requestTimeoutSeconds];
}

- (NSString *)doGet:(NSString *)url paramNames:(NSArray *)paramNames paramValues:(NSArray *)paramValues
{
    return [WebServiceUtil doBasicMethod:url isDownload:NO isPostMethod:NO paramNames:paramNames paramValues:paramValues requestTimeoutInterval:_requestTimeoutSeconds];
}

- (NSString *)doPost:(NSString *)url paramNames:(NSArray *)paramNames paramValues:(NSArray *)paramValues
{
    return [WebServiceUtil doBasicMethod:url isDownload:NO isPostMethod:YES paramNames:paramNames paramValues:paramValues requestTimeoutInterval:_requestTimeoutSeconds];
}

- (NSData *)doDownload:(NSString *)url paramNames:(NSArray *)paramNames paramValues:(NSArray *)paramValues
{
    return [WebServiceUtil doBasicMethod:url isDownload:YES isPostMethod:YES paramNames:paramNames paramValues:paramValues requestTimeoutInterval:_requestTimeoutSeconds];
}

- (BOOL)doDownloadToSave:(NSString *)url paramNames:(NSArray *)paramNames paramValues:(NSArray *)paramValues saveTo:(NSString *)saveTo
{
    NSData* data = [WebServiceUtil doBasicMethod:url isDownload:YES isPostMethod:YES paramNames:paramNames paramValues:paramValues requestTimeoutInterval:_requestTimeoutSeconds];
...
- (NSString *)doUpload:(NSString *)url paramNames:(NSArray *)paramNames paramValues:(NSArray *)paramValues multiPartNames:(NSArray *)multiPartNames multiPartFilePaths:(NSArray *)multiPartFilePaths
{
    ...
    return [WebServiceUtil doMultipartMethod:url isDownload:NO paramNames:paramNames paramValues:paramValues filePartValues:multiPartArray requestTimeoutInterval:_requestTimeoutSeconds];
}
